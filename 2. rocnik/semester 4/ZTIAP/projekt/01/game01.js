...
// the default animation type "loop":
...
Game.Collider = function() {
  ...
  /* I made this so all the checks happen in y first order. */
...
Game.Object.prototype = {
  ...
  /* Does rectangular collision detection. */
...
Game.MovingObject = function(x, y, width, height, velocity_max = 15) {
  ...
  this.jumping      = false;
  this.velocity_max = velocity_max;// velocity_max so velocity can't go past 16
  this.velocity_x   = 0;
  this.velocity_y   = 0;
  this.x_old        = x;
  this.y_old        = y;
...
Game.TileSet = function(columns, tile_size) {
  ...
  this.frames = [new f(115,  96, 13, 16, 0, -4), // idle-left
                 ...
                 new f( 81, 112, 14, 16), new f(96, 112, 16, 16), // soul
...
Game.World.prototype = {
  ...
  setup:function(zone) {
    ...
    for (let index = zone.souls.length - 1; index > -1; -- index) {
      ...
      this.souls[index] = new Game.Soul(soul[0] * this.tile_set.tile_size + 5, soul[1] * this.tile_set.tile_size - 2);

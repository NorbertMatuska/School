...
public class MonternaWorkerStolicka extends View {

    public MonternaWorkerStolicka(Stage window, DataClass Data){
    ...
    public void render() throws ClassNotFoundException, IOException {
        ...
        Oak.setOnAction(e->{
            ...
            {
                try {
                    Router.goTo(ROUTES.STOLICKAMONTER,this.data,"Oak");
                } catch (IOException ioException) {
                    ioException.printStackTrace();
                } catch (ClassNotFoundException classNotFoundException) {
                    classNotFoundException.printStackTrace();
        ...
        Birch.setOnAction(e->{
            ...
            {
                try {
                    Router.goTo(ROUTES.STOLICKAMONTER ,this.data, "Birch");
                } catch (IOException ioException) {
                    ioException.printStackTrace();
                } catch (ClassNotFoundException classNotFoundException) {
                    classNotFoundException.printStackTrace();
        ...
        Spruce.setOnAction(e->{
            ...
            {
                try {
                    Router.goTo(ROUTES.STOLICKAMONTER,this.data,"Spruce");

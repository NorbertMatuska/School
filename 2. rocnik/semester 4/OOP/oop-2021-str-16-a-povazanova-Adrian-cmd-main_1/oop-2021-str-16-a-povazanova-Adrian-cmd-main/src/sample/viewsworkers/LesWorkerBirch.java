...
public class LesWorkerBirch extends View {

    ArrayList<WoodCutter> osoby;

    public LesWorkerBirch(Stage window, DataClass Data){
    ...
    public void render() throws ClassNotFoundException, IOException {
        ...
        for(WoodCutter w : osoby)
        {
            ...
            push.setOnAction(e->{
                ...
                System.out.println("clovek : " + w.getName());

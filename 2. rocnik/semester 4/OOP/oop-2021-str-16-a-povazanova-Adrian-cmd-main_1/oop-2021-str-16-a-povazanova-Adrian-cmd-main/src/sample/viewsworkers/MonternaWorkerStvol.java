...
public class MonternaWorkerStvol extends View {

    public MonternaWorkerStvol(Stage window, DataClass Data){
    ...
    public void render() throws ClassNotFoundException, IOException {
        ...
        Oak.setOnAction(e->{
            ...
            {
                try {
                    Router.goTo(ROUTES.STVOLMONTER,this.data,"Oak");
                } catch (IOException ioException) {
                    ioException.printStackTrace();
                } catch (ClassNotFoundException classNotFoundException) {
                    classNotFoundException.printStackTrace();
        ...
        Birch.setOnAction(e->{
            ...
            {
                try {
                    Router.goTo(ROUTES.STVOLMONTER,this.data,"Birch");
                } catch (IOException ioException) {
                    ioException.printStackTrace();
                } catch (ClassNotFoundException classNotFoundException) {
                    classNotFoundException.printStackTrace();
        ...
        Spruce.setOnAction(e->{
            ...
            {
                try {
                    Router.goTo(ROUTES.STVOLMONTER,this.data,"Spruce");
